...
export default {
  ...
  "baseUrl": "/",
  "organizationName": "LaunchFlow",
  "projectName": "BuildFlow",
  "onBrokenLinks": "throw",
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/home/tanke/launchflow/buildflow-docs/sidebars.js",
        ...
        "theme": {
          "customCss": "/home/tanke/launchflow/buildflow-docs/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2023 BuildFlow"
    },
    "prism": {
      "theme": {
        "plain": {
